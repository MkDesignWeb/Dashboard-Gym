                ...
                <div className="bg-white w-96 h-64 rounded-lg flex justify-center items-center">
                    <form className="flex flex-col justify-center w-full h-full p-10 text-primary text-xl font-medium gap-5 relative">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="email" name="usuario" id="" className="border-primary border-2 rounded-md focus:outline-none text-base text-black h-10 px-2 mt-1" />
                        </div>
                        ...
                        <div className="flex flex-col relative">
                            ...
                            <input type="password" name="senha" id="" className="border-primary border-2 rounded-md focus:outline-none text-black h-10 px-2 mt-1" />
